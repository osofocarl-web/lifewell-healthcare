...
export default function AboutPage() {
  return (
    <div className="bg-brand-bg min-h-screen pt-4 pb-24">
      ...
      {/* Clinical Leadership */}
      <section className="py-24 border-y border-brand-bg bg-white">
                ...
                <div className="bg-brand-bg p-8 rounded-3xl border border-gray-100 flex flex-col md:flex-row gap-8 items-center justify-between">
                  <div>
                    ...
                    <div className="flex flex-col gap-3">
                      <a href="mailto:Ida_kubi@hotmail.co.uk" className="flex items-center gap-3 text-brand-blue hover:text-brand-gold transition-premium font-bold">
                        <Mail size={18} /> Ida_kubi@hotmail.co.uk
                      </a>
                      <a href="tel:07916311377" className="flex items-center gap-3 text-brand-blue hover:text-brand-gold transition-premium font-bold">
                        <Phone size={18} /> 07916 311377
                      </a>
                    </div>
                  </div>
